...
class CrowdInfluenceModel:
    ...
    def compute_crowd_impact(
        ...
        alpha = CrowdInfluenceModel.ALPHA_HOME if is_home_team else CrowdInfluenceModel.ALPHA_AWAY
        ...
        stress_factor = 1.0
        if heart_rate:
            hr_stress = CrowdInfluenceModel.heart_rate_stress_factor(heart_rate, match_minute)
