    ...
    <div className="page-container">
      ...
      <div className="command-header">
        <div className="command-identity">
          <div className="cmd-label"><Zap size={14} style={{ display: 'inline', marginRight: '6px' }} /> Game Plan</div>
          <h1>{current.title}</h1>
          <p>{current.description}</p>
        </div>
        <div style={{ textAlign: 'right' }}>
          <div style={{ fontSize: '24px', fontWeight: '900', color: 'var(--flare)', fontFamily: 'var(--font-mono)', marginBottom: '6px' }}>{current.pmuMultiplier}</div>
          <div style={{ fontSize: '10px', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>PMU Mult.</div>
        </div>
      </div>

      {/* Tactic Selector Grid */}
      <div style={{ marginBottom: '18px' }}>
        <div className="section-title" style={{ marginBottom: '12px' }}>Select Tactic</div>
          ...
          {tactics.map(tactic => (
            <button
              ...
              style={{
                ...
                border: `1px solid ${selectedTactic === tactic ? 'var(--flare)' : 'var(--border-subtle)'}`,
