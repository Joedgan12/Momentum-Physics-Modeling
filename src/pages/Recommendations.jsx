      ...
      <div className="page-container">
        <div className="command-header">
          <div className="command-identity">
            <div className="cmd-label"><Lightbulb size={14} style={{ display: 'inline', marginRight: '6px' }} /> Insights</div>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <p style={{ margin: '0 0 8px 0', fontSize: '12px', color: 'var(--text-secondary)', lineHeight: '1.5' }}>
                    {rec.rationale || rec.description || 'See impact details below'}
                  </p>
                  {rec.impact_score != null && (
                    <div style={{ fontSize: '10px', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)' }}>
                      Impact Score: <span style={{ color: 'var(--plasma)', fontWeight: '700' }}>
