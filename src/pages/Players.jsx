      ...
      <div className="page-container">
        <div className="command-header">
          <div className="command-identity">
            <div className="cmd-label"><Users size={14} style={{ display: 'inline', marginRight: '6px' }} /> Analysis</div>
            ...
            <tbody>
              {topPlayers.map((player, idx) => (
                <tr key={idx}>
                  ...
                  <td><span className="player-name">{player.name || 'N/A'}</span></td>
                  <td><span className="position">{player.position || 'N/A'}</span></td>
                  <td>
