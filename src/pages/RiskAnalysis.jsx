      ...
      <div className="page-container">
        <div className="command-header">
          <div className="command-identity">
            <div className="cmd-label"><AlertTriangle size={14} style={{ display: 'inline', marginRight: '6px' }} /> Exposure Map</div>
            <h1>Risk Analysis</h1>
    ...
    <div className="page-container">
      ...
      <div className="command-header">
        ...
        <div style={{ textAlign: 'right' }}>
          <div style={{ fontSize: '28px', fontWeight: '900', color: riskColor(risk.overall_risk_score || 0), fontFamily: 'var(--font-mono)', marginBottom: '6px' }}>
            {risk.overall_risk_level || '—'}
          </div>
          <div style={{ fontSize: '10px', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Risk Level</div>
        </div>
      </div>
